...
(function ($) {
    ...
    */
    ...
    $.bg_urls = ["static/img/sample9.jpg"];
    ...
    $.wordrotator_words = ['<h4>beautify photos</h4>', '<h4>make funny pcitures</h4>']; //-- Array of words, for headline text
    ...
    $(document).ready(function (e) {
        ...
        $('.menu-link').on('click', function () {
			...
			$ ('.description1'). each (function () {
			 if (section_pos == -100 && section_posy == -100) {
				//当元素在屏幕的可视区域时添加 fade-in 动画
				$ (this) .addClass ("animation fade-in-up delay-05s");
			  } 
			 if (section_pos != -100 && section_posy != -100) {
				// 当元素在屏幕的不可视区域时移除 fade-in 动画
				$ (this) .removeClass ("animation fade-in-up delay-05s");
			  } 
			});
			$ ('.description2'). each (function () {
			 if (section_pos == -100 && section_posy == -100) {
				//当元素在屏幕的可视区域时添加 fade-in 动画
				$ (this) .addClass ("animation fade-in-up delay-1s");
			  } 
			 if (section_pos != -100 && section_posy != -100) {
				// 当元素在屏幕的不可视区域时移除 fade-in 动画
				$ (this) .removeClass ("animation fade-in-up delay-1s");
			  } 
			});
			$ ('.description3'). each (function () {
			 if (section_pos == -100 && section_posy == -100) {
				//当元素在屏幕的可视区域时添加 fade-in 动画
				$ (this) .addClass ("animation fade-in-up delay-1-5s");
			  } 
			 if (section_pos != -100 && section_posy != -100) {
				// 当元素在屏幕的不可视区域时移除 fade-in 动画
				$ (this) .removeClass ("animation fade-in-up delay-1-5s");
			  } 
			});
